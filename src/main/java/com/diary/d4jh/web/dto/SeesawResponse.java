...
public class SeesawResponse<T> {
	...
	*/
	...
	public static <T extends Object> SeesawResponse<T> build(SeesawResultCode result, T body,String tempProjId) {
		return new SeesawResponse<T>()
				.setHeader(SeesawHeader.of()
						.setResponseResult(result))
				.setBody(body);
	...
	public static <T> SeesawResponse<T> ok(T body,String tempProjId) {
		return new SeesawResponse<T>()
				.setHeader(SeesawHeader.of()
						.setResponseResult(SeesawResultCode.SUCCESS))
				.setBody(body);
	...
	public static <T> SeesawResponse<T> ok(String tempProjId) {
		return new SeesawResponse<T>()
				.setHeader(SeesawHeader.of()
						.setResponseResult(SeesawResultCode.SUCCESS));
	}

	public static <T> SeesawResponse<T> build(SeesawResultCode result, String tempProjId) {
		return new SeesawResponse<T>()
				.setHeader(SeesawHeader.of()
						.setResponseResult(result));
	}
